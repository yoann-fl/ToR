...
bool_t guiResourcesManagerInit(void)
{
	...
	// Fill images array
	_imagesArray[0].pointer = &imgtoken_w;
	_imagesArray[0].filePath = "token_w.bmp";
	_imagesArray[1].pointer = &imgtoken;
	_imagesArray[1].filePath = "token.bmp";
	...
	// Open fonts
	_fontsArray[0] = gdispOpenFont("arial__14_arial14_aa");
	_fontsArray[1] = gdispOpenFont("arial_12_arial12_aa");
